...
const EXERCISES = {
  legpress:     { name: "Leg Press",        muscle: "Quadricipiti",      secondary: "Glutei, Femorali",          type: "machine", inc: 10, sets: 3, reps: 15, repsMax: 15, rest: '90"', bodyPart: "legs",      tip: "Non portare le ginocchia oltre le punte dei piedi e non bloccare completamente le gambe in estensione: mantieni una leggera flessione." },
  ...
  chestpress:   { name: "Chest Press",      muscle: "Pettorali",         secondary: "Tricipiti, Deltoidi ant.",   type: "machine",  sets: 3, reps: 10, repsMax: 12, rest: '90"', bodyPart: "chest",     tip: "Tieni le scapole aderenti allo schienale per tutto il movimento. Non spingere le spalle in avanti nella fase di spinta." },
  ...
  latmachine:   { name: "Lat Machine",      muscle: "Gran Dorsale",      secondary: "Bicipiti, Romboidi",         type: "cable",    sets: 3, reps: 10, repsMax: 12, rest: '90"', bodyPart: "back",      tip: "Non tirare il bilanciere fino al petto: arriva al mento. Inizia il movimento aprendo le scapole, non piegando i gomiti." },
